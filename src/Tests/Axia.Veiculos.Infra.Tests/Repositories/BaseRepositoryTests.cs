...
public class BaseRepositoryTests : IDisposable
{
    ...
    [Fact]
    public async Task GetByIdAsync_EntidadeExistente_DeveRetornar()
    {
        //Arrange
        var veiculo = Veiculo.Create("Teste", Marca.Toyota, "Corolla");
    ...
    [Fact]
    public async Task GetByIdAsync_EntidadeInexistente_DeveRetornarNull()
    {
        //Act
    ...
    [Fact]
    public async Task GetAllAsync_ComEntidades_DeveRetornarTodas()
    {
        //Arrange
    ...
    {
        //Arrange
        var veiculo = Veiculo.Create("Novo", Marca.Chevrolet, "Onix");
    ...
    [Fact]
    public async Task DeleteAsync_EntidadeExistente_DeveRemover()
    {
        //Arrange
        var veiculo = Veiculo.Create("ParaDeletar", Marca.Jeep, "Compass");
        await _context.Veiculos.AddAsync(veiculo);
        await _context.SaveChangesAsync();
